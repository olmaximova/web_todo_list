...
const MENU_ITEMS = [
    { id: 'add-task', text: 'add task', icon: 'images/add.png', action: openAddTaskModal },
    { id: 'search-task', text: 'search for tasks', icon: 'images/search.png', action: openSearchModal },
    { id: 'view-all', text: 'all tasks', icon: 'images/list.png', action: () => filterTasksByDate('view-all') },
    { id: 'view-due-today', text: 'tasks due today', icon: 'images/calendar_clock.png', action: () => filterTasksByDate('view-due-today') },
    { id: 'view-upcoming', text: 'upcoming tasks', icon: 'images/calendar_month.png', action: () => filterTasksByDate('view-upcoming') },
    { id: 'view-expired', text: 'expired tasks', icon: 'images/timer_off.png', action: () => filterTasksByDate('view-expired') }
];
